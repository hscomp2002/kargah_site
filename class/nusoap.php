...
* @access   public
*/
class soapclient_nu extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclient_nu($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends soapclient_nu {
	'.$evalStr.'
}';
		return $evalStr;
	}
